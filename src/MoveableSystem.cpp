...
void Moveable::move(const double& _dt) {
    ...
    /*    std::cout<<
                 getPosition().axis_one<<" "<<
                 getPosition().axis_two<<" "<<
                 getPosition().axis_three<<" "<<
                 std::endl;*/
...
void Moveable::setSpeedComposition(double const& velFront, double const& velLat, double const& velz) {
    ...
    SpeedLateral = velLat;
    if (0 != velz) {
        std::cout << "Moveable::setSpeedComposition Not supported velz:" << velz << std::endl;
    }
}
...
void Moveable::setSpeedDelta(double const& velFront, double const& velLat, double const& velz) {
    ...
    SpeedLateral += velLat;
    if (0 != velz) {
        std::cout << "Moveable::setSpeedDelta Not supported velz:" << velz << std::endl;
    }
}
...
void Moveable::setOrientation(double const& angle1, double const& angle2, double const& angle3) {
    ...
    Pitch = angle2;
    if (0 != angle3) {
        std::cout << "Moveable::setOrientation Not supported angle3:" << angle3 << std::endl;
    }
}
...
void Moveable::setOrientationDelta(double const& angle1, double const& angle2, double const& angle3) {
    ...
    Pitch += angle2;
    if (0 != angle3) {
        std::cout << "Moveable::setOrientationDelta Not supported angle3:" << angle3 << std::endl;
    }
}
